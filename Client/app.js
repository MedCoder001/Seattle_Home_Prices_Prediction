...
function onClickedEstimatePrice() {
    ...
    var size = document.getElementById("uiSizeSqft").value; 
    var lot_size = document.getElementById("uiLotSqft").value; 
    var beds = getBedroomsValue(); 
    var baths = getBathroomsValue(); 
    var zipcodes = document.getElementById("uiZipcodes").value; 
    var estPrice = document.getElementById("uiEstimatedPrice");

    // var url = "http://127.0.0.1:5000/predict_home_price";
    var url = "/api/predict_home_price"; // because we are using nginx as reverse proxy
...
function onPageLoad() {
    ...
    var url = "/api/get_zipcodes"; // because we are using nginx as reverse proxy
